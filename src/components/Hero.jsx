...
export const Hero = () => {
      ...
      <div className="hero-container">
        ...
        >
          ...
          <motion.div className="social-links" variants={staggerContainer}>
            <motion.a target="_blank" href="https://github.com/Ghising-Palsang">
              <i className="fab fa-github"></i>
            </motion.a>
            <motion.a
              target="_blank"
              href="https://www.linkedin.com/in/palsang-ghising/"
            >
  ...
  stack: {
    ...
    frameworks: ["React", "TailwindCSS", "Express"],
  },
  traits: [
    "pixel-perfectionist",
    "API whisperer",
  ...
  availability: "Available for hire",
          ...
          >
            <div className="card-content">
              ...
              <span className="card-text">Currently working on MERN</span>
            </div>
          </motion.div>
          {/*Floating Card */}
        </motion.div>
